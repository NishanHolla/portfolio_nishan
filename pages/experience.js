...
export default function Experience() {
  ...
  return (
    <div>
      <h3 data-aos="slide-up" className="animate-pulse text-5xl ml-20 dark:text-teal-600 md:text-center">EXPERIENCE AND QUALIFICATIONS</h3><br /><br /><br /><br />
      ...
      <div className="from-teal-500 w-50 h-30 hover:bg-gray-900 mx-auto mt-10 text-center">
        ...
        <div data-aos="slide-up" className="text-2xl text-white hover:text-teal-500">
          <p>🥇 1st Place, inGenius 12.0 Hackathon - InGenius Community<br />Worked on improving supply chain and information retrieval for medicine tracking (2024)</p><br />
          <p>🥇 1st Place, Kalpana Hack For Humanity - IEEE Society<br />Developed a Mental Health Wellbeing App using Embeddings and Langchain (2024)</p><br />
          <p>🏅 Top 10, Kodikon 3.0 National Level Hackathon - Club Embrione<br />Researched and built AR tech using Machine Learning (2023)</p><br />
          <p>🏅 Ranked #15 in Open Source Contributions Runner Up - ACM Hacktober Fest IEEE Society<br />Closed multiple issues in open source projects (2023)</p>
        </div>
      </div>
    </div>
  );
